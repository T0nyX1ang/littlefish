...
+   自动发送42点昨日战绩：每天00:04:30进行推送，误差为30秒，该功能自动触发，广播至小鱼加入的**所有**群中。 <Badge text="!" type="error"/>
...
## 其它功能
+   B站直播推送：小鱼每隔20秒查询订阅用户名单中的所有用户，如果某个用户处于直播状态，小鱼将会发送TA的直播间地址。 <Badge text="!" type="error"/>
