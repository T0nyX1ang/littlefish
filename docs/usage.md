...
> 42点游戏规则(暂定): 每日8-23时的42分42秒, 我会给出5个位于0至13之间的整数，你需要将这五个整数(可以调换顺序)通过四则运算与括号相连，使得结果等于42. 回答时以"calc42"或"42点"开头，加入空格，并给出算式. 在当前小时的59分59秒，会统计该问题的等价解与每名玩家的求解个数. 如果需要查询等价解说明，请输入"42点等价解"或"等价解说明". 如果需要查询当前问题，请输入"当前问题"或"当前42点"，机器人会私戳当前问题.
